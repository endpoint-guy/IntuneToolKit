...
.NOTES
    ...
    Requires: Windows PowerShell 5.1, Microsoft.Graph.Authentication
...
if (-not (Get-Module -ListAvailable -Name Microsoft.Graph.Authentication)) {
    [System.Windows.MessageBox]::Show(
        "Microsoft.Graph.Authentication is not installed.`n`nRun:`n  Install-Module Microsoft.Graph.Authentication -Scope CurrentUser",
